                    ...
                    {props => (
                        <Form className="form-group">
                            <div className="row" id={"frm"}>
                                <label className="col-4 col-sm-3 col-md-2 col-lg-2 col-xl-1" htmlFor="jobType">Job
                                    type: </label>
                                <Field
                            ...
                            {props.values.jobType === "job-appsimulator-flinksim-" && (
                                <div>
                                    <div className="row" id={"frm"}>
                                        <label className="col-4 col-sm-3 col-md-2 col-lg-2 col-xl-1" htmlFor="jobName">Job
                                            name: </label>
                                        <Field className="col-4 col-sm-3 col-md-2 col-lg-2 col-xl-2" type="jobName"
                                               name="jobName"/>
                                    ...
                                    <div className="row justify-content-sm-start" id={"frm"}>
                                        ...
                                        <Field className="col-4 col-sm-3 col-md-2 col-lg-2 col-xl-2" type="pageLoadTime"
                                               name="pageLoadTime"/>
                                        <ErrorMessage name="pageLoadTime" component="div"/>
                                    </div>
                                    <div className="row justify-content-sm-start" id={"frm"}>
                                        <label className="col-4 col-sm-3 col-md-2 col-lg-2 col-xl-1"
                                               htmlFor="numberOfRequestsPerLoad">Requests per
                                            load: </label>
                                    ...
                                    <div className="row justify-content-sm-start" id={"frm"}>
                                        ...
                                        <Field className="col-4 col-sm-3 col-md-2 col-lg-2 col-xl-2" type="memoryUsage"
                                               name="memoryUsage"/>
                                        <ErrorMessage name="memoryUsage" component="div"/>
                                    </div>
                                    <div className="row justify-content-sm-start" id={"frm"}>
                                        <label className="col-4 col-sm-3 col-md-2 col-lg-2 col-xl-1" htmlFor="pageSize">Page
                                            size: </label>
                                        <Field className="col-4 col-sm-3 col-md-2 col-lg-2 col-xl-2" type="pageSize"
                                               name="pageSize"/>
                                    ...
                                    <div className="row justify-content-sm-start" id={"frm"}>
                                        ...
                                        <Field className="col-4 col-sm-3 col-md-2 col-lg-2 col-xl-2" type="responseSize"
                                               name="responseSize"/>
                                    ...
                                    <div className="row justify-content-sm-start" id={"frm"}>
                                        ...
                                        <Field className="col-4 col-sm-3 col-md-2 col-lg-2 col-xl-2" type="latency"
                                               name="latency"/>
                                    ...
                                    <div className="row justify-content-sm-start" id={"frm"}>
                                        ...
                                        <Field className="col-4 col-sm-3 col-md-2 col-lg-2 col-xl-2" type="bandwidth"
                                               name="bandwidth"/>
                                        <ErrorMessage name="bandwidth" component="div"/>
                                    </div>
                                    <div className="row justify-content-sm-start" id={"frm"}>
                                        <label className="col-4 col-sm-3 col-md-2 col-lg-2 col-xl-1"
                                               htmlFor="intervalBetweenRequests">Interval between
                                            requests: </label>
                                        <Field className="col-4 col-sm-3 col-md-2 col-lg-2 col-xl-2"
